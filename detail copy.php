              ...
              <div class="row m-sm-0">
                <div class="col-sm-2 p-sm-0 order-2 order-sm-1 mt-2 mt-sm-0">
                  <div class="owl-thumbs d-flex flex-row flex-sm-column" data-slider-id="1">
                    <?php 
                      $sql_img = "SELECT * FROM product_imges WHERE id_pro = $id_pro";
                      $result_img = $conn->query($sql_img);
                      while ($row_img = $result_img->fetch_assoc()) {
                        ?>
                          <div class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0"><img style="width: 90px; height: 90px;" src="../admin/assets/img/upload/<?=$row_img['img_names']?>" alt="..."></div>
                        <?php
                      }
                    ?>
                  </div>
                ...
                <div class="col-sm-10 order-1 order-sm-2">
                  ...
                  <a class="d-block" href="assets/img/product-detail-1.jpg" data-lightbox="product" title="Product item 1"><img class="img-fluid" src="assets/img/product-detail-1.jpg" alt="..."></a>
                  <a class="d-block" href="assets/img/product-detail-2.jpg" data-lightbox="product" title="Product item 2"><img class="img-fluid" src="assets/img/product-detail-2.jpg" alt="..."></a>
                  <a class="d-block" href="assets/img/product-detail-3.jpg" data-lightbox="product" title="Product item 3"><img class="img-fluid" src="assets/img/product-detail-3.jpg" alt="..."></a>
                  <a class="d-block" href="assets/img/product-detail-4.jpg" data-lightbox="product" title="Product item 4"><img class="img-fluid" src="assets/img/product-detail-4.jpg" alt="..."></a>
                </div>
                </div>
              </div>
            </div>
