            ...
            <div class="modal-body p-0">
              <div class="row align-items-stretch">
                <div class="col-lg-6 p-lg-0">
                  <a class="product-view d-block h-100 bg-cover bg-center" style="background: url(img/product-5.jpg)" href="img/product-5.jpg" data-lightbox="productview" title="Red digital smartwatch"></a>
                  <a class="d-none" href="img/product-5-alt-1.jpg" title="Red digital smartwatch" data-lightbox="productview"></a>
                  <a class="d-none" href="img/product-5-alt-2.jpg" title="Red digital smartwatch" data-lightbox="productview"></a></div>
                <div class="col-lg-6">
              ...
              <div class="row m-sm-0">
                ...
                <div class="col-sm-10 order-1 order-sm-2">
                  <div class="owl-carousel product-slider" data-slider-id="1">
                    ...
                    while ($row_img = $result_img->fetch_assoc()) {
                    ?>
                    <a class="d-block" href="../admin/assets/img/upload/<?=$row_img['img_names']?>" data-lightbox="product" title="Product item<?=$row_img['id']?>"><img class="../admin/assets/img/upload/<?=$img['img_names']?>" alt="..."></a>
                    <?php
                    } 
                    ?>
                    </div>
