              ...
              while ($row = $result->fetch_assoc()) {
                ?>
                  <div class="col-md-4 mb-4 mb-md-0">
                    <a class="category-item mb-4" href="shop.php"><img class="img-fluid" style="height: 250px; width: 100%;" src="../admin/assets/img/upload/<?=$row['cover']?>" alt=""><strong class="category-item-title"><?=$row['name']?></strong></a>
                  </div>
                <?php
              }
            ?>
